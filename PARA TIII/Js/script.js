...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Niña, quise escribirte esto porque a los 3 meses de conocidos no tuvimos tiempo para hablar, ni pasar tiempo pues no se si sea exagerado esto pero de todas formas te lo hice y la verdad desde que te conoci mejore bastante en varios aspectos me ayudas a ser mejor cada dia porque sos una mujer maravillosa,guapa,inteligente,valiente y claro como yo voy a ser un desastre porque te miro cada dia y digo tengo que ser mejor para ella, soy una de esas personas que piensa que se necesita a una persona para ser uno mismo y definitivamente esa persona sos vos, 5 minutitos contigo para mi son 1 hora, la razon por la que me gusta tanto pasar tiempo contigo es porque despues de un dia largo y cansado sos la unica persona que me da ganas de hablar todo el rato, no importa que tan cansado este o que me haya pasado en ese dia, cuando paso tiempo contigo siento que puedo hablar durante horas sin parar,es como si fuera que mi corazon y mi mente se sintieran mas ligeros, para mi siempre vas a ser vos,gracias por cruzarte en mi camino y coincidir conmigo y recorda bien esto Te quiero por sueño y por alma, no por soledad ni vacio.<3`;  } else {
...
function showSignature() {
  ...
  signature.textContent =firma?decodeURIComponent(firma):"Con Cariño, Arturo <3 ";
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-07-13T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Tiempo de conocidos,pitufina: <b>${days}</b> días<br>` +
      `Proxima pelea ajasjash : <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
